...
################################################################
# This is a generated script based on design: xor_gate
#
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} \
  ...
  # Create instance: xor_component_0, and set properties
  set block_name xor_component
  set block_cell_name xor_component_0
  if { [catch {set xor_component_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xor_component_0 eq "" } {
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins xor_component_0/A]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins xor_component_0/B]
  ...
  connect_bd_net -net xor_component_0_Y [get_bd_ports Y] [get_bd_pins xor_component_0/Y]
