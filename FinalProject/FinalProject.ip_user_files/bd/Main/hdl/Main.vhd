...
entity Main is
  ...
  attribute CORE_GENERATION_INFO of Main : entity is "Main,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Main,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=10,numReposBlks=10,numNonXlnxBlks=6,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of Main is
  ...
  component Main_HallSensorEmulation_0_0 is
  port (
    comparator : in STD_LOGIC_VECTOR ( 2 downto 0 );
    hall_out : out STD_LOGIC_VECTOR ( 2 downto 0 );
    clk_200M_in : in STD_LOGIC
  );
  end component Main_HallSensorEmulation_0_0;
  component Main_pwm_0_0 is
  port (
    pwm_out : out STD_LOGIC;
    duty_in : in STD_LOGIC_VECTOR ( 7 downto 0 );
    clk_200M_in : in STD_LOGIC
  );
  end component Main_pwm_0_0;
  component Main_unity_ctrl_0_0 is
  port (
    clk_i : in STD_LOGIC;
    rx_i : in STD_LOGIC;
    tx_o : out STD_LOGIC;
  ...
  end component Main_unity_ctrl_0_0;
  component Main_debounce_0_0 is
  port (
    clk_200M_in : in STD_LOGIC;
    raw_signal_in : in STD_LOGIC;
  ...
  end component Main_debounce_0_0;
  ...
  component Main_blcd_driver_0_0 is
  port (
    hall_in : in STD_LOGIC_VECTOR ( 2 downto 0 );
    pwm : in STD_LOGIC;
    A_in : out STD_LOGIC;
  ...
  end component Main_blcd_driver_0_0;
  component Main_bldc_starter_0_0 is
  port (
    clk_200M_in : in STD_LOGIC;
    btn1 : in STD_LOGIC;
    pwm : in STD_LOGIC;
  ...
  end component Main_bldc_starter_0_0;
  signal HallSensorEmulation_0_hall_out : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal blcd_driver_0_A_in : STD_LOGIC;
  signal blcd_driver_0_A_inh : STD_LOGIC;
  signal blcd_driver_0_B_in : STD_LOGIC;
  signal blcd_driver_0_B_inh : STD_LOGIC;
  signal blcd_driver_0_C_in : STD_LOGIC;
  signal blcd_driver_0_C_inh : STD_LOGIC;
  signal bldc_starter_0_A_in : STD_LOGIC;
  signal bldc_starter_0_A_inh : STD_LOGIC;
  signal bldc_starter_0_B_in : STD_LOGIC;
  signal bldc_starter_0_B_inh : STD_LOGIC;
  signal bldc_starter_0_C_in : STD_LOGIC;
  signal bldc_starter_0_C_inh : STD_LOGIC;
  signal comparator_1 : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal NLW_unity_ctrl_0_duty_out_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_unity_ctrl_0_led_o_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
begin
  A_in <= bldc_starter_0_A_in;
  A_inh <= bldc_starter_0_A_inh;
  B_in <= bldc_starter_0_B_in;
  B_inh <= bldc_starter_0_B_inh;
  C_in <= bldc_starter_0_C_in;
  C_inh <= bldc_starter_0_C_inh;
  comparator_1(2 downto 0) <= comparator(2 downto 0);
  raw_signal_in_1 <= raw_signal_in;
  rx_i_1 <= rx_i;
  tx_o <= unity_ctrl_0_tx_o;
HallSensorEmulation_0: component Main_HallSensorEmulation_0_0
     port map (
      clk_200M_in => processing_system7_0_FCLK_CLK1,
      comparator(2 downto 0) => comparator_1(2 downto 0),
      hall_out(2 downto 0) => HallSensorEmulation_0_hall_out(2 downto 0)
    );
blcd_driver_0: component Main_blcd_driver_0_0
     port map (
      A_in => blcd_driver_0_A_in,
      A_inh => blcd_driver_0_A_inh,
      B_in => blcd_driver_0_B_in,
      B_inh => blcd_driver_0_B_inh,
      C_in => blcd_driver_0_C_in,
      C_inh => blcd_driver_0_C_inh,
      hall_in(2 downto 0) => HallSensorEmulation_0_hall_out(2 downto 0),
      pwm => pwm_0_pwm_out
    );
bldc_starter_0: component Main_bldc_starter_0_0
     port map (
      A_bypass => blcd_driver_0_A_in,
      A_in => bldc_starter_0_A_in,
      A_inh => bldc_starter_0_A_inh,
      Ah_bypass => blcd_driver_0_A_inh,
      B_bypass => blcd_driver_0_B_in,
      B_in => bldc_starter_0_B_in,
      B_inh => bldc_starter_0_B_inh,
      Bh_bypass => blcd_driver_0_B_inh,
      C_bypass => blcd_driver_0_C_in,
      C_in => bldc_starter_0_C_in,
      C_inh => bldc_starter_0_C_inh,
      Ch_bypass => blcd_driver_0_C_inh,
      btn1 => debounce_0_filtered_signal_out,
      clk_200M_in => processing_system7_0_FCLK_CLK1,
      hall_in(2 downto 0) => HallSensorEmulation_0_hall_out(2 downto 0),
      pwm => pwm_0_pwm_out
    );
debounce_0: component Main_debounce_0_0
     port map (
      clk_200M_in => processing_system7_0_FCLK_CLK1,
      delay_in(23 downto 0) => xlconstant_1_dout(23 downto 0),
...
pwm_0: component Main_pwm_0_0
     port map (
      clk_200M_in => processing_system7_0_FCLK_CLK1,
      duty_in(7 downto 0) => xlconstant_0_dout(7 downto 0),
      pwm_out => pwm_0_pwm_out
    );
unity_ctrl_0: component Main_unity_ctrl_0_0
     port map (
      clk_i => processing_system7_0_FCLK_CLK1,
      duty_in(7 downto 0) => xlconstant_0_dout(7 downto 0),
      duty_out(7 downto 0) => NLW_unity_ctrl_0_duty_out_UNCONNECTED(7 downto 0),
      hall_in(2 downto 0) => HallSensorEmulation_0_hall_out(2 downto 0),
      led_o(7 downto 0) => NLW_unity_ctrl_0_led_o_UNCONNECTED(7 downto 0),
      rx_i => rx_i_1,
      tx_o => unity_ctrl_0_tx_o
    );
