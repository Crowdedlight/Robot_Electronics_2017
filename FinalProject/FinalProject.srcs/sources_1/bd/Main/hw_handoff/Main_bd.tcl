...
# module references:
# HallSensorEmulation, blcd_driver, bldc_starter, debounce, pwm, unity_ctrl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set A_in [ create_bd_port -dir O A_in ]
  set A_inh [ create_bd_port -dir O A_inh ]
  set B_in [ create_bd_port -dir O B_in ]
  set B_inh [ create_bd_port -dir O B_inh ]
  set C_in [ create_bd_port -dir O C_in ]
  set C_inh [ create_bd_port -dir O C_inh ]
  set comparator [ create_bd_port -dir I -from 2 -to 0 comparator ]
  set raw_signal_in [ create_bd_port -dir I raw_signal_in ]
  set rx_i [ create_bd_port -dir I rx_i ]
  set tx_o [ create_bd_port -dir O tx_o ]

  # Create instance: HallSensorEmulation_0, and set properties
  set block_name HallSensorEmulation
  set block_cell_name HallSensorEmulation_0
  if { [catch {set HallSensorEmulation_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $HallSensorEmulation_0 eq "" } {
  ...
  set block_cell_name blcd_driver_0
  if { [catch {set blcd_driver_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $blcd_driver_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: bldc_starter_0, and set properties
  set block_name bldc_starter
  set block_cell_name bldc_starter_0
  if { [catch {set bldc_starter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bldc_starter_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net HallSensorEmulation_0_hall_out [get_bd_pins HallSensorEmulation_0/hall_out] [get_bd_pins blcd_driver_0/hall_in] [get_bd_pins bldc_starter_0/hall_in] [get_bd_pins unity_ctrl_0/hall_in]
  connect_bd_net -net blcd_driver_0_A_in [get_bd_pins blcd_driver_0/A_in] [get_bd_pins bldc_starter_0/A_bypass]
  connect_bd_net -net blcd_driver_0_A_inh [get_bd_pins blcd_driver_0/A_inh] [get_bd_pins bldc_starter_0/Ah_bypass]
  connect_bd_net -net blcd_driver_0_B_in [get_bd_pins blcd_driver_0/B_in] [get_bd_pins bldc_starter_0/B_bypass]
  connect_bd_net -net blcd_driver_0_B_inh [get_bd_pins blcd_driver_0/B_inh] [get_bd_pins bldc_starter_0/Bh_bypass]
  connect_bd_net -net blcd_driver_0_C_in [get_bd_pins blcd_driver_0/C_in] [get_bd_pins bldc_starter_0/C_bypass]
  connect_bd_net -net blcd_driver_0_C_inh [get_bd_pins blcd_driver_0/C_inh] [get_bd_pins bldc_starter_0/Ch_bypass]
  connect_bd_net -net bldc_starter_0_A_in [get_bd_ports A_in] [get_bd_pins bldc_starter_0/A_in]
  connect_bd_net -net bldc_starter_0_A_inh [get_bd_ports A_inh] [get_bd_pins bldc_starter_0/A_inh]
  connect_bd_net -net bldc_starter_0_B_in [get_bd_ports B_in] [get_bd_pins bldc_starter_0/B_in]
  connect_bd_net -net bldc_starter_0_B_inh [get_bd_ports B_inh] [get_bd_pins bldc_starter_0/B_inh]
  connect_bd_net -net bldc_starter_0_C_in [get_bd_ports C_in] [get_bd_pins bldc_starter_0/C_in]
  connect_bd_net -net bldc_starter_0_C_inh [get_bd_ports C_inh] [get_bd_pins bldc_starter_0/C_inh]
  connect_bd_net -net comparator_1 [get_bd_ports comparator] [get_bd_pins HallSensorEmulation_0/comparator]
  connect_bd_net -net debounce_0_filtered_signal_out [get_bd_pins bldc_starter_0/btn1] [get_bd_pins debounce_0/filtered_signal_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins HallSensorEmulation_0/clk_200M_in] [get_bd_pins bldc_starter_0/clk_200M_in] [get_bd_pins debounce_0/clk_200M_in] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins pwm_0/clk_200M_in] [get_bd_pins unity_ctrl_0/clk_i]
  connect_bd_net -net pwm_0_pwm_out [get_bd_pins blcd_driver_0/pwm] [get_bd_pins bldc_starter_0/pwm] [get_bd_pins pwm_0/pwm_out]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins pwm_0/duty_in] [get_bd_pins unity_ctrl_0/duty_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins debounce_0/delay_in] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins debounce_0/reset_in] [get_bd_pins xlconstant_2/dout]
