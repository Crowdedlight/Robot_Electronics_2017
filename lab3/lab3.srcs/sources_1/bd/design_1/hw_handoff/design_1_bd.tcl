...
# module references:
# blcd_driver, bldc_decoder, duty_module, pwm_8bit
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set U_in [ create_bd_port -dir O U_in ]
  set U_inh [ create_bd_port -dir O U_inh ]
  set V_in [ create_bd_port -dir O V_in ]
  ...
  # Create instance: bldc_decoder_0, and set properties
  set block_name bldc_decoder
  set block_cell_name bldc_decoder_0
  if { [catch {set bldc_decoder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bldc_decoder_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: duty_module_0, and set properties
  set block_name duty_module
  set block_cell_name duty_module_0
  if { [catch {set duty_module_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $duty_module_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} \
  ...
  # Create instance: pwm_8bit_0, and set properties
  set block_name pwm_8bit
  set block_cell_name pwm_8bit_0
  if { [catch {set pwm_8bit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pwm_8bit_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net blcd_driver_0_U_in [get_bd_ports U_in] [get_bd_pins blcd_driver_0/U_in]
  connect_bd_net -net blcd_driver_0_U_inh [get_bd_ports U_inh] [get_bd_pins blcd_driver_0/U_inh]
  connect_bd_net -net blcd_driver_0_V_in [get_bd_ports V_in] [get_bd_pins blcd_driver_0/V_in]
  connect_bd_net -net blcd_driver_0_V_inh [get_bd_ports V_inh] [get_bd_pins blcd_driver_0/V_inh]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins bldc_decoder_0/clk_200M_in] [get_bd_pins duty_module_0/clk_200M_in] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins pwm_8bit_0/clk_200M_in]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins bldc_decoder_0/reset_in] [get_bd_pins pwm_8bit_0/reset]
